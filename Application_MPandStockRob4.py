...
## Specify SVAR
name = "Application_MPandStock_m4"
...
if __name__ == '__main__':
    ...
    opt_redform['lags'] = 12  # Use 4 lags (one year)
    data_block1 = np.array([
        us_ip[tempindex],
        us_cpi[tempindex]
    ])
    ...
    if estimator_CUE_Blocks:
        ...
        # Generate and save Figure 5 in the appendix
        fig_name =  'FiguresAndTables\FigureAppendixC7.pdf'
        fig.savefig(fig_name, format='pdf', dpi=300)
        eps_filename =  'FiguresAndTables\FigureAppendixC7.eps'
